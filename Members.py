...
# ---------------------------Main function---------------------------#
def members(a):
    global image1   # gloabising variables to be used outside function
    global label1
    global b
    ...
    def members_details():
        ...
        id_entry.place(relx=0.13, rely=0.61)
        ...
        name_entry.place(relx=0.13, rely=0.794)

        date_label = Label(members_frame, text="Date of joining",
                           width=13, bd=2, bg='black', fg='white')
        date_label.place(relx=0.51, rely=0.61)
        ...
        contact_no_label = Label(members_frame, text='Contact Number',
                                 ...
                                 fg='white')
        contact_no_label.place(relx=0.51, rely=0.794)
        ...
        search_button.place(relx=0.73, rely=0.01, height=30, width=40)
